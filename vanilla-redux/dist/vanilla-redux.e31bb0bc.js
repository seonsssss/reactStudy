...
var assertFunction = (func, expected) => {
  if (typeof func !== "function") {
    throw new TypeError("development" === "production" ? formatProdErrorMessage(32) : `${expected} is not a function`);
  }
};
var noop2 = () => {};
...
var btnIDecrease = document.querySelector("#decrease");
...
btnIDecrease.onclick = function () {
  store.dispatch(counterSlice.actions.decrease());
};
},{"@reduxjs/toolkit":"node_modules/@reduxjs/toolkit/dist/redux-toolkit.legacy-esm.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
